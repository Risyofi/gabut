            ...
            <div class="box">
                <div class="formulir">
                    ...
                    <form action="edit.php" enctype="multipart/form-data" method="post">
                        ...
                        <input type="text" name="id_kamar" value="<?= $data['id_kamar']; ?>">
                        ...
                        <input type="text" name="harga_kamar" id="harga" required value="<?= $data['harga_kamar']; ?>" />
...
//update data
    mysqli_query($conn, "UPDATE kamar SET id_adminFK=$idAdmin, harga_kamar='$harga',tipe_kamar='$tipe',
    keterangan=$keterangan ,gambar_kamar='$gambar' WHERE id = '$idKamar'");
